...
st.write("※本ツールは、厚生労働省が公表する「簡易版23項目ストレスチェック」（資料 ＜https://stresscheck.mhlw.go.jp/download/material/sc23.pdf＞）を参考に作成したものです。")
st.write("本チェックは、あくまで「あなたの現在の心の傾向を知るため」のものであり、医師による診断や治療を目的としたものではありません。")
st.write("心身の不調が続く、または強いストレスを感じる場合には、速やかに専門の医療機関・産業保健（保健師・看護師）にご相談ください。")
